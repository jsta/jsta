...
if __name__ == "__main__":
    ...
    releases = list(filter(lambda r: r["repo"] not in ["LAGOS_GIS_Toolbox", "LAGOSClimateSensitivity", "rgrass7sf", "tidybayes", "openbugs", "spnetwork", "LAGOS_NETS", "LivinOnTheEdge"], releases))
